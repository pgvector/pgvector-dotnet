...
public class DapperTests
{
    ...
    public async Task Main()
    {
        ...
        conn.Execute("CREATE TABLE dapper_items (id serial PRIMARY KEY, embedding vector(3), halfembedding halfvec(3), sparseembedding sparsevec(3))");
        ...
        conn.Execute(@"INSERT INTO dapper_items (embedding, halfembedding, sparseembedding) VALUES (@embedding1, @halfEmbedding1, @sparseEmbedding1), (@embedding2, @halfEmbedding2, @sparseEmbedding2), (@embedding3, @halfEmbedding3, @sparseEmbedding3)", new { embedding1, halfEmbedding1, sparseEmbedding1, embedding2, halfEmbedding2, sparseEmbedding2, embedding3, halfEmbedding3, sparseEmbedding3 });
